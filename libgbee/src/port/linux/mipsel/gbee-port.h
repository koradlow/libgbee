/**
 * \page building_for_linux_mipsel Building for Linux on MIPSel
 * \section  building_for_linux_mipsel Building for Linux on MIPSel
 *
 ...
 * \code
 * ~/xbee/build/linux/mipsel/libgbee
 * \endcode
 *
 * I have used OpenWRT for this build. There is a toolchain file for OpenWRT
 * in the MIPSel port directory, so make sure to select <i>Specify toolchain
 * file for cross-compiling</i> when asked for the generator in cmake-gui.
 * The following table gives the parameters that allow to configure the build
 * system for Linux on MIPSel.
 *
 ...
 * <td>TARGET_CPU</td>
 * <td>
 * Selects the CPU (architecture) of the target system; set to \a mipsel.
 * </td>
 * </tr>
 * <tr>
 ...
 * browse to your build directory and type make.
 *
 * \file
 * \author  d264
 * \version $Rev$
 ...
 * \section DESCRIPTION
 *
 * This is a port of the GBee driver for MIPSel Linux systems.
 *
 * \section LICENSE
 *
